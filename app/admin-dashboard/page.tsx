    ...
    <div className="app">
      ...
      <Sidebar badge={<span className="admin-chip">Admin</span>}>
        ...
        <nav className="nav-section">
          ...
          {/* Soon — hidden until this page ships: <a className="nav-item" href="#"><svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg><span className="label">Appointments</span><span className="badge">Soon</span></a> */}
        </nav>
        <nav className="nav-section">
          <p className="nav-label">System</p>
          {/* Soon — hidden until this page ships: <a className="nav-item" href="#"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93A10 10 0 104.93 19.07M19.07 4.93l-7.07 7.07"/></svg><span className="label">Settings</span><span className="badge">Soon</span></a> */}
