    ...
    <div className="app">
      ...
      <Sidebar badge={<span className="brand-badge">MD</span>}>
        <div style={{padding:"0.75rem 0.75rem 0.25rem"}}>
          <div className="sidebar-doctor">
            ...
            <div className="doc-info-sm">
              <p className="nm">{userData?.users?.[0]?.full_name}</p>
        ...
        <nav className="nav-section" style={{marginTop:"auto"}}>
          <a className="nav-item" href="#">
            <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93A10 10 0 104.93 19.07"/></svg>
            <span>Settings</span>
            <span className="bdg">Soon</span>
          </a>
          <a className="nav-item" onClick={signOut} style={{cursor:"pointer"}}>
