              ...
              <div>
                ...
                <div className="info-section">
                  ...
                  <div className="info-grid">
                    ...
                    <div className="info-box"><div className="ib-label">Email</div><div className="ib-val" style={{fontSize:"12.5px"}}>{drawerDept.email}</div></div>
